...
The results can be localized and now also cached! Localization only seems to effect title, plotoutline and recommendations (titles only). Check wiki homepage to enable.<br>
